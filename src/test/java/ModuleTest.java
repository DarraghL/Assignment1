...
public class ModuleTest {
    ...
    @BeforeEach
    void setUp() {
        module = new Module("Software Engineering", "CT417", "Michael");
    ...
    public void testGetLecturer(){
        assertEquals("Michael", module.getLecturer());
    }

    @Test
    public void testSetLecturer(){
        module.setLecturer("Frank");
        assertEquals("Frank", module.getLecturer());
    }
